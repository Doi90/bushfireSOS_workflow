...
## Data available: PO
## Type of SDM: PresBG
## Number of presence records:6193
## Number of background points:9962
...
#override region variable to exclude WA and SA
...
map_sp_data(spp_data, only_presences = FALSE)

## SA and WA data do not look useful, re-run to remove them. TGB also too closely aligned with presences, switch to random
