...
## Species:Calyptorhynchus lathami halmaturinus
## Guild:Birds
## Region:SA
## Analyst:August
## Reviewer:David
...
## Data available: PO
## Type of SDM: PresBG
## Number of presence records:55
## Number of background points:9877
## Type of background points:random
## Date completed:17/07/2020
## Any other comments: turned off parameter tuning to use default reg param = 1
...
#check map
map_sp_data(spp_data, only_presences = F)
#######################
### Data Extraction ###
#######################
