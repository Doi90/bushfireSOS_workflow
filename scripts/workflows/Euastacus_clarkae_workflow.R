...
## Number of presence records: 15
## Number of background points: NA
## Type of background points: NA
## Date completed: 4/7/20
## Any other comments: Possible revisit with more lax coordinate uncertainty restrictions.
