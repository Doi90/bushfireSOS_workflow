...
# ## Already looks low, check with spatial filtering
# nrow(pixel_filtering(data = mask_species_data(spp_data$data, region), raster = raster::raster("bushfireResponse_data/spatial_layers/bushfire_terre_layers_250_AA.tif")))
# #32 records, proceed
...
#write the cropped raster for future use
raster::writeRaster(env_data,"bushfireResponse_data/NSW_pred.tif")
