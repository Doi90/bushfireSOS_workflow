...
## Species:Hoplocephalus_bungaroides                           # Scientific names?
## Guild:Reptiles                            # Or whatever we want to call our groups
## Region: NSW                           # Eastern seaboard/WA/Kangaroo Island?
## Analyst:Darren Southwell                           # Name of person who implemented workflow
## Reviewer:David Wilkinson                          # Name of person who checked workflow
## SDM Required: Yes                  # Retain option to indicate method
