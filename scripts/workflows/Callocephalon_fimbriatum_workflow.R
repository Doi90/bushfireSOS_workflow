...
## Data available: PO
## Type of SDM: PresBG
## Number of presence records:5221
## Number of background points:16078
...
# TAS population no longer exists, mask it out
prediction <- bushfireSOS::mask_data(prediction, region = region[-grep("TAS",region)])
