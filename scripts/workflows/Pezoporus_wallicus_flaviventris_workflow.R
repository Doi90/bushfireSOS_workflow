...
## Species: Pezoporus wallicus flaviventris
## Guild: Birds
## Region: WA
## Analyst: Adam
## Reviewer: David
...
## Data available: PO
## Type of SDM: PresBG
## Number of presence records: 4
## Number of background points: NA
## Type of background points: NA
## Date completed:14/7/20
## Any other comments: Only four (4) data points found. Species name is Pezoporus flaviventris NOT Pezoporus wallicus flaviventris.

species <- "Pezoporus flaviventris"
