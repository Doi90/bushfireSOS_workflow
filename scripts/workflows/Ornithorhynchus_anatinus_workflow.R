...
## Data available: PO
## Type of SDM: PresBG
## Number of presence records: 2920
## Number of background points: 9904
## Type of background points: Random
## Date completed:12/07/2020
## Any other comments: changed to random background and from default to lqp
