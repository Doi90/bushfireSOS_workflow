...
## Guild: Birds
## Region: NSW, VIC, Jervis Bay Territory, QLD
...
## Data available: PO
## Type of SDM: PresBG
## Number of presence records: 477
## Number of background points: 16845
## Type of background points: Target group
## Date completed: 10/7/2020
## Any other comments: Prediction not so good north of sydney, might need to re-run with spatial term
