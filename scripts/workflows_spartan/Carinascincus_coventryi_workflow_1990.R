...
## Species: Carinascincus coventryi
## Guild: Reptiles
## Region:
## Analyst:
## Reviewer:
...
## Date completed:
## Any other comments: Created workflow script as Carinascincus coventryi. In VIC and NSW species was listed as Niveoscincus coventryi. I changed the names of the files from NSW and VIC, but the species name in the file stays the same.
