...
# remove records outside Autralia (naturalearth apparently is not working well)
spp_data$data <- spp_data$data[spp_data$data$Longitude<155,]

# remove outliers by coordinates
spp_data <- bushfireSOS::remove_points(spp_data, long = c(144.7202, 141.3224), lat = c(-36.74880, -38.21426))
