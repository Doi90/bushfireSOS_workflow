...
## Species:                           # Eulamprus tympanum
## Guild:                             # Reptiles
## Region:                            # "NSW" "VIC" "ACT"
## Analyst:                           # Roozbeh Valavi
## Reviewer:                          # Adam Amart @assma1
...
## Number of occurrence               # 239
## Number of backgrounds              # 10000
...
# region <- c("NSW", "VIC", "ACT")
spp_data$data <- spp_data$data[spp_data$data$ID != 1558, ]
