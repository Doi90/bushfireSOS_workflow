...
# # spp_data$map
# 
# # remove one outlier by coordinates
# # spp_data <- bushfireSOS::remove_points(spp_data, long = 59.88388, lat = 39.86527) this point is the Middle East, but this function  didn't work as apparently does not function if points have positive latitudes, so I'm writing the code directly
# 
# spp_data$data <- spp_data$data[!(spp_data$data$Longitude == 59.88388 & spp_data$data$Latitude == 39.86527),]
# 
# 
