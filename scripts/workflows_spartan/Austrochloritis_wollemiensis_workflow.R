...
## Species: Austrochloritis wollemiensis
## Guild: invertebrates
## Region:
## Analyst:
## Reviewer:
...
saveRDS(spp_data,
        sprintf("bushfireResponse_data/outputs/spp_data_tmp/spp_data_%s.rds",
                gsub(" ", "_", species)))

# spp_data <- readRDS(sprintf("bushfireResponse_data/outputs/spp_data_tmp/spp_data_%s.rds",
#                             gsub(" ", "_", species)))
...
env_data <- bushfireSOS::load_env_data(stack_dir = "bushfireResponse_data/spatial_layers/raster_tiles/layers_inverts",
                                       region = region)
...
saveRDS(meta_data,
        sprintf("bushfireResponse_data/outputs/meta_data/meta_daa_%s.rds",
                gsub(" ", "_", species)))
