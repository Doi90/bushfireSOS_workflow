...
## Date completed:
## Any other comments: In Victoria all records are cassified as subspecies Notamacropus rufogriseus banksianus. I changed name to csv file to be able to read in the data.
...
# 
# # remove outlier by region
# region <- c("VIC", "SA",  "NSW", "QLD", "TAS", "ACT")
# 
