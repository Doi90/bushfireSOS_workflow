...
## Species: Sminthopsis fuliginosus aitkeni
## Guild: Mammals
## Region: SA (KI)
## Analyst: Roozbeh
## Reviewer: August
...
## Data available: PO
## Type of SDM: PresBG
## Number of presence records: 27
## Number of background points: 9854
## Type of background points: random (from KI)
## Date completed: 17-07-2020
## Any other comments: 

# species <- "Sminthopsis griseoventer aitkeni"
species <- "Sminthopsis fuliginosus aitkeni"
